...
int main(int argc, char const *argv[])
{
    ...
    printf("execve=0x%p\n", execve);
     ...
     //compararing here if the running one is child process
...
/*message sent by client will be stored in buffer */
            ...
            //code part included for second assignment 
            
            int Dupe_Parent = dup(new_socket);
            if(Dupe_Parent==-1)
            ...
            sprintf(stringSocket,"%d",Dupe_Parent);
